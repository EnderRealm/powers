...
description: CSS token system and semantic styling patterns. Use when creating or modifying styles, theming, fixing styling inconsistencies, or building web UX components.
---
